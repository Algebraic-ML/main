...
G.Dual()
#G.Dual()
#print(G.Dual().getNodesByID('zero_'))
#print(G.Dual().getNodesByID('Constant_1,2w_dual'))
#print(G.Dual().getAllNodeID())
#print([x.ID for x in G.Dual().getAllSons(G.Dual().getNodesByID('v_dual'))])
